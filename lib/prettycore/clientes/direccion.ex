defmodule Prettycore.Clientes.Direccion do
  ...
  schema "CTE_DIRECCION" do
    ...
    belongs_to :cliente, Prettycore.Clientes.Cliente, foreign_key: :ctecli_codigo_k, references: :ctecli_codigo_k, define_field: false
    belongs_to :patron_frecuencia, Prettycore.Clientes.PatronFrecuencia, foreign_key: :ctepfr_codigo_k, references: :ctepfr_codigo_k, define_field: false
    belongs_to :estado, Prettycore.Clientes.Estado, foreign_key: :mapedo_codigo_k, references: :mapedo_codigo_k, define_field: false
    belongs_to :municipio, Prettycore.Clientes.Municipio, foreign_key: :mapmun_codigo_k, references: :mapmun_codigo_k, define_field: false
    belongs_to :localidad, Prettycore.Clientes.Localidad, foreign_key: :maploc_codigo_k, references: :maploc_codigo_k, define_field: false
  end
end
