defmodule PrettycoreWeb.MenuLayout do
  ...
  def pc_icon(assigns) do
    ...
    <%= case @name do %>
      ...
      <% "programacion" -> %>
        <svg viewBox="0 0 24 24">
          <path fill="currentColor" d="M4 4c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h6v2H8c-.6 0-1 .4-1 1s.4 1 1 1h8c.6 0 1-.4 1-1s-.4-1-1-1h-2v-2h6c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2H4Z"/>
        </svg>
      ...
      <% "config" -> %>
        <svg viewBox="0 0 24 24">
          <path fill="currentColor" d="M10.7 2.3c.4-.6 1.2-.6 1.6 0l1 1.6c.2.3.5.5.9.6l1.8.5c.7.2 1.1.9.9 1.5l-.5 1.8c-.1.3 0 .7.3 1l1.4 1.4c.5.5.5 1.3 0 1.8l-1.4 1.4c-.3.3-.4.6-.3 1l.5 1.8c.2.7-.2 1.4-.9 1.5l-1.8.5c-.4.1-.7.3-.9.6l-1 1.6Z"/>
        </svg>

      <% "programacion_sql" -> %>
        <svg viewBox="0 0 24 24">
          <path fill="currentColor" d="M12 3C7.6 3 4 4.3 4 6v12c0 1.7 3.6 3 8 3s8-1.3 8-3V6c0-1.7-3.6-3-8-3Z"/>
        </svg>

      <% "logout" -> %>
        <svg viewBox="0 0 24 24">
          <path fill="currentColor" d="M10 4a1 1 0 0 1 1 1v3h2V5a3 3 0 0 0-3-3H7a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h3a3 3 0 0 0 3-3v-3h-2v3a1 1 0 0 1-1 1H7Z"/>
        </svg>
